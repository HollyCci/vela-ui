...
export const formsVariantDemos: Record<string, ReactNode> = {
  'cell-color-picker-controlled': <CellColorPickerDemo />,
  'cell-color-picker-default': <CellColorPickerDemo />,
  'cell-color-picker-disabled': <CellColorPickerDemo />,
  'cell-color-picker-settings-group': <CellColorPickerDemo />,
  'cell-color-picker-variants': <CellColorPickerDemo />,
  'cell-color-picker-with-presets': <CellColorPickerDemo />,
  'cell-select-controlled': <CellSelectDemo />,
  'cell-select-custom-value': <CellSelectDemo />,
  'cell-select-default': <CellSelectDemo />,
  'cell-select-disabled': <CellSelectDemo />,
  'cell-select-font-family': <CellSelectDemo />,
  'cell-select-settings-group': <CellSelectDemo />,
  'cell-select-variants': <CellSelectDemo />,
  'cell-slider-controlled': <CellSliderDemo />,
  'cell-slider-default': <CellSliderDemo />,
  'cell-slider-disabled': <CellSliderDemo />,
  'cell-slider-integer-step': <CellSliderDemo />,
  'cell-slider-secondary-group': <CellSliderDemo />,
  'cell-slider-settings-group': <CellSliderDemo />,
  'cell-slider-variants': <CellSliderDemo />,
  'cell-switch-controlled': <CellSwitchDemo />,
  'cell-switch-default': <CellSwitchDemo />,
  'cell-switch-disabled': <CellSwitchDemo />,
  'cell-switch-feature-announcement': <CellSwitchDemo />,
  'cell-switch-secondary-group': <CellSwitchDemo />,
  'cell-switch-settings-group': <CellSwitchDemo />,
  'cell-switch-variants': <CellSwitchDemo />,
  'checkbox-button-group-controlled': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-custom-indicator': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-default': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-disabled-group': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-grid-layout': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-icon-cards': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-no-indicator': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-render-prop-children': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-subscription-plans': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-with-icons': <CheckboxButtonGroupDemo />,
  'checkbox-button-group-with-ripple': <CheckboxButtonGroupDemo />,
  ...
  'inline-select-custom-indicator': <InlineSelectDemo />,
  'inline-select-default': <InlineSelectDemo />,
  'inline-select-multi-select': <InlineSelectDemo />,
  'inline-select-placements': <InlineSelectDemo />,
  'inline-select-team-switcher': <InlineSelectDemo />,
  'native-select-controlled': <NativeSelectDemo />,
  'native-select-custom-indicator': <NativeSelectDemo />,
  'native-select-default': <NativeSelectDemo />,
  'native-select-disabled-select': <NativeSelectDemo />,
  'native-select-form-example': <NativeSelectDemo />,
  'native-select-full-width': <NativeSelectDemo />,
  'native-select-invalid-state': <NativeSelectDemo />,
  'native-select-variants': <NativeSelectDemo />,
  'native-select-with-description': <NativeSelectDemo />,
  'native-select-with-disabled-options': <NativeSelectDemo />,
  'native-select-with-groups': <NativeSelectDemo />,
  'native-select-with-label': <NativeSelectDemo />,
  'number-stepper-controlled': <NumberStepperDemo />,
  'number-stepper-custom-icons': <NumberStepperDemo />,
  'number-stepper-custom-value': <NumberStepperDemo />,
  'number-stepper-default': <NumberStepperDemo />,
  'number-stepper-disabled': <NumberStepperDemo />,
  'number-stepper-guest-picker': <NumberStepperDemo />,
  'number-stepper-min-max-values': <NumberStepperDemo />,
  'number-stepper-reversed-layout': <NumberStepperDemo />,
  'number-stepper-sizes': <NumberStepperDemo />,
  'number-stepper-with-custom-buttons': <NumberStepperDemo />,
  'number-stepper-with-format-options': <NumberStepperDemo />,
  'number-stepper-with-label': <NumberStepperDemo />,
  'number-stepper-with-step': <NumberStepperDemo />,
  'radio-button-group-controlled': <RadioButtonGroupDemo />,
  'radio-button-group-custom-indicator': <RadioButtonGroupDemo />,
  'radio-button-group-default': <RadioButtonGroupDemo />,
  'radio-button-group-delivery-and-payment': <RadioButtonGroupDemo />,
  'radio-button-group-disabled-group': <RadioButtonGroupDemo />,
  'radio-button-group-grid-layout': <RadioButtonGroupDemo />,
  'radio-button-group-icon-cards': <RadioButtonGroupDemo />,
  'radio-button-group-no-indicator': <RadioButtonGroupDemo />,
  'radio-button-group-render-prop-children': <RadioButtonGroupDemo />,
  'radio-button-group-subscription-plans': <RadioButtonGroupDemo />,
  'radio-button-group-with-icons': <RadioButtonGroupDemo />,
  'radio-button-group-with-ripple': <RadioButtonGroupDemo />,
};
