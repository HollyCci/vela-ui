...
const highRiskNotes = {
  ...
  command: 'Smoke covers dialog filtering, clear-slot reset, result restoration, and execution; still needs full keyboard command navigation and grouped result comparison.',
  'context-menu': 'Smoke covers keyboard opening, long press, action dispatch, and submenu selection; checkbox/radio items and same-viewport comparison remain pending.',
